...
```{r}
heartrate <- read_csv(here("lab008", "data2", "heartrate.csv"))
```
...
```{r}
pivot_longer(heartrate, #data frame
             cols = c("a", "b", "c", "d"), #columns to pivot
             names_to = "treatment", #name of new column
             values_to = "heartrate" #name of new column
             )
```
